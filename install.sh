...
|---|---|
| Sales, revenue, orders, D2C, B2B, customers, invoices | `/kiro-sales` |
| Inventory, stock levels, SKUs, products | `/kiro-sales` |
| Ad performance, Meta ads, Google ads, ROAS, spend | `/kiro-sales` |
| Financial data, P&L, accounting, Zoho | `/kiro-sales` |
...
echo "  Or just ask:      \"What were Kiro's sales today?\""
echo ""
